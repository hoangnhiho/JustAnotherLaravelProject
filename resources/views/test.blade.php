...
<body id="home" class="homepage">
    ...
    <section id="">
        <!-- <div class="container wow fadeInDown"> -->
            <div class="row wow fadeInDown" style="margin: 0px 0px">
                <div class="col-xs-12" style="padding: 0px 0px">
                    <img class="img-responsive" src="{{ url('images/buy/world_map.png') }}" style="width:100%" alt=""/>
                </div>
            </div>
        <!-- </div> -->
    </section>
        ...
        <div class="container">
            ...
            <div class="portfolio-items">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ url('images/portfolio/04.jpg') }}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ url('images/portfolio/05.jpg') }}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ url('images/portfolio/06.jpg') }}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 5</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ url('images/portfolio/07.jpg') }}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ url('images/portfolio/08.jpg') }}" alt="">
                        <div class="portfolio-info">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{ url('images/team/01.jpg') }}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Bin Burhan</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{ url('images/team/02.jpg') }}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Man</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{ url('images/team/03.jpg') }}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Pahlwan</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{ url('images/team/04.jpg') }}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Nasir uddin</h3>
                            <span>UI/UX</span>
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="{{ url('images/testimonial/01.jpg') }}" alt=""></p>
            ...
            <div class="row">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="{{ url('images/blog/01.jpg') }}" alt="">
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="{{ url('images/blog/02.jpg') }}" alt="">
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="{{ url('images/blog/03.jpg') }}" alt="">
